...
import com.zionflame.imperiumserver.config.tarefa.AtualizaStatusFaturaHandler;
...
public class CompraCartaoController {
	...
	public ResponseEntity<?> adicionar(@RequestBody CompraCartaoForm form, UriComponentsBuilder uriBuilder) {
		...
		AtualizaStatusFaturaHandler atualizaStatusFaturaHandler = new AtualizaStatusFaturaHandler(cartaoRepository,
				faturaRepository);
